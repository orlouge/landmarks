    ...
    public DensityFunction.DensityFunctionVisitor getVisitor() {
        ...
        DensityFunction.DensityFunctionVisitor visitor = function -> {
            switch (function) {
                ...
                case FeatureRandomNumber random -> {
                ...
                case FunctionWithCache.Simple cached when cached.key() != null -> {
                ...
                case FeatureBlockMatches block -> {
                    return block.create(world);
                }
                case FeatureBiomeMatches block -> {
                    return block.create(world);
                }
                case FeatureUserParameter params when userParameters.containsKey(params.parameter) -> {
                    return params.create(userParameters.get(params.parameter));
                }
                case FeatureMinY param -> {
                    return param.create(minY);
                }
                case FeatureMaxY param -> {
                    return param.create(maxY);
                }
                case FeatureOriginX param -> {
                    return param.create(origin.getX());
                }
                case FeatureOriginY param -> {
                    return param.create(origin.getY());
                }
                case FeatureOriginZ param -> {
                    return param.create(origin.getZ());
                }
                case FeatureMinX param -> {
                    return param.create(minX);
                }
                case FeatureMinZ param -> {
                    return param.create(minZ);
                }
                case FeatureMaxX param -> {
                    return param.create(maxX);
                }
                case FeatureMaxZ param -> {
