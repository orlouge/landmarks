...
public class FeatureOriginZ implements DensityFunction.SimpleFunction {
    public static final MapCodec<FeatureOriginZ> CODEC = MapCodec.unit(new FeatureOriginZ());
    public static final KeyDispatchDataCodec<FeatureOriginZ> CODEC_HOLDER = KeyDispatchDataCodec.of(CODEC);
