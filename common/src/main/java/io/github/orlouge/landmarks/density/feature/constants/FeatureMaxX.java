...
public class FeatureMaxX implements DensityFunction.SimpleFunction {
    public static final MapCodec<FeatureMaxX> CODEC = MapCodec.unit(new FeatureMaxX());
    public static final KeyDispatchDataCodec<FeatureMaxX> CODEC_HOLDER = KeyDispatchDataCodec.of(CODEC);
